    ...
    */
        ...
        void animation_phase(void) {
            switch (get_highest_layer(layer_state)) {
                ...
                case _COLEMAKDH:
                    ...
                    break;
                default:
                    // All other layers use tap animation
    ...
    bool oled_task_user(void) {
        if (timer_elapsed32(last_input_activity) > OLED_TIMEOUT) {
            oled_off();  // turn off the OLED after timeout
            return false;
        }
    
        oled_on();  // make sure OLED is on when there's activity
